...
const faqData = [
  {
    question: 'What is Lucyy?',
    answer:
      'Lucyy is a torrent site that allows users to download and share copyrighted content such as movies, music, software, and more.',
  },
  {
    question: 'How does Lucyy work?',
    answer:
      'Users can search for their desired content on Lucyy and download it using a BitTorrent client. Lucyy operates on a peer-to-peer network, meaning that users download files from other users who have already downloaded them',
  },
  {
    question: 'How can I protect my privacy while using Lucyy?',
    answer:
      'To protect your privacy while using Lucyy, consider using a VPN (Virtual Private Network) to hide your IP address and encrypt your internet connection. This will help prevent your online activities from being tracked.',
  },
  {
    question: "What if I can't find the content I'm looking for on Lucyy?",
    answer:
      "Lucyy is a user-driven platform, and the availability of content depends on what other users have uploaded. If you can't find what you're looking for, it may not be available on Lucyy.",
  },
  {
    question: 'Is it safe to download from Lucyy?',
    answer:
